...
mksock "$TESTDIR/var/run/mysqld/mysqld.sock"
mksock "$TESTDIR/var/run/mysql.sock"
mksock "$TESTDIR/var/run/mariadb.sock"
mksock "$TESTDIR/var/run/postgresql/.s.PGSQL.5432"
mksock "$TESTDIR/var/run/postgresql/other.sock"
...
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[mysql/mariadb]: $TESTDIR/var/run/mysqld/mysqld.sock" "T3f: mysqld.sock tagged"
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[mysql/mariadb]: $TESTDIR/var/run/mysql.sock" "T3g: mysql.sock tagged"
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[mysql/mariadb]: $TESTDIR/var/run/mariadb.sock" "T3h: mariadb.sock tagged"
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[postgresql]: $TESTDIR/var/run/postgresql/.s.PGSQL.5432" "T3i: PGSQL wildcard tagged"
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[postgresql]: $TESTDIR/var/run/postgresql/other.sock" "T3j: postgresql dir tagged"
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[memcached]: $TESTDIR/var/run/memcached.sock" "T3k: memcached.sock tagged"
teardown_fixture
...
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[mysql/mariadb]:" "T9d: mysql/mariadb tagged in mixed fixture"
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[postgresql]:" "T9e: postgresql tagged in mixed fixture"
assert_contains "$OUT" "WRITABLE_AF_UNIX_SOCK[memcached]:" "T9f: memcached tagged in mixed fixture"
